...
# Cambiamos los emojis por indicadores universales de texto [->]
...
class MenuScreen(Screen):
    ...
    def inicializar_menu(self):
        ...
        # Botones con texto formateado universal
...
class EditarRutinaScreen(Screen):
    def __init__(self, **kwargs):
        ...
        rutinas = cargar_rutinas()
        self.spinner_dias = Spinner(text="-- Selecciona el Día a Editar --", values=list(rutinas.keys()), size_hint_y=None, height=dp(50), background_color=
